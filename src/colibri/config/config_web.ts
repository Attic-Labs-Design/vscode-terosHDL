        ...
        <div class="settings-body">
            ...
            <div class="settings-section" id="linter-vhdlls">
                ...
                <div class="settings-group-description">Fast VHDL language server and analysis library written in Rust.</div>
                    ...
                    <div class="setting-item">
                        <div class="setting-item-label">
                            Pick whether VHDL types are uppercase or lowercase
                            <span class="markConfig" id="mark_linter-vhdlls-case"></span>
                        </div>
                        <div class="select-container">
                            <select class="setting-select-box" id="linter-vhdlls-case">
...
<script>
  ...
  function get_config(){
    ...
    element_value = document.getElementById("linter-vhdlls-case").value;
    config["linter"]["vhdlls"]["case"] = element_value
  ...
  function set_config(config){
    ...
    if (config["linter"] && config["linter"]["vhdlls"] && config["linter"]["vhdlls"]["case"] !== undefined) {
        document.getElementById("linter-vhdlls-case").value = config["linter"]["vhdlls"]["case"];
    }
  ...
  function set_mark(config, projectName){
    ...
    mark = "";
    if (projectName !== undefined && config["linter"] && config["linter"]["vhdlls"] && config["linter"]["vhdlls"]["case"] !== undefined) {
        mark = MODIFIEDMSG;
    }
    document.getElementById("mark_linter-vhdlls-case").innerHTML = mark;
    mark = "";
